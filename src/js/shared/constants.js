...
export const PUBLIC_THREAD_LINK = 'PUBLIC_THREAD_LINK'
export const PRIVATE_THREAD_LINK = 'PRIVATE_THREAD_LINK'
export const DEFAULT_THREAD_LINK = PUBLIC_THREAD_LINK
