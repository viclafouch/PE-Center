...
export const PUBLIC_ANSWER_LINK = 'PUBLIC_ANSWER_LINK'
export const PRIVATE_ANSWER_LINK = 'PRIVATE_ANSWER_LINK'
export const DEFAULT_ANSWER_LINK = PUBLIC_ANSWER_LINK
