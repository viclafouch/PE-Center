...
const anchors = document.querySelectorAll('[data-location]');
const linktoWebsite = document.getElementById('toWebsite');
...
/* What I just need for search feature */
...
/* Chrome doesn't redirect with the <a> tag, so I use function */
